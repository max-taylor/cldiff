...
- [x] 1.0 Project Scaffolding & CLI Setup
  - **Dependencies:** none
  - **Requirements:** REQ-STACK (Node/Bun, Ink, TypeScript), REQ-CLI (`gitscope`)
...
- [ ] 7.0 Inline Comments System
  - **Dependencies:** 4.0
  - **Requirements:** REQ-COMMENTS (`c` keybind, file:line anchor), REQ-PERSIST (`.gitscope/comments.jsonl`), REQ-COMMENT-SCHEMA (id, file, line, branch, content, resolved, createdAt)
